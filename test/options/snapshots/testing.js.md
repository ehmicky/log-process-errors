...
## [node-tap:default] [multipleResolves] should allow overriding 'opts.level'
...
## [node-tap:default] [multipleResolves] should make tests fails
...
## [node-tap:default] [multipleResolves] should work with the -r flag
...
## [node-tap:default] [rejectionHandled] should allow overriding 'opts.level'
...
## [node-tap:default] [rejectionHandled] should make tests fails
...
## [node-tap:default] [rejectionHandled] should work with the -r flag
...
## [node-tap:default] [uncaughtException] should allow overriding 'opts.level'
...
## [node-tap:default] [uncaughtException] should make tests fails
...
## [node-tap:default] [uncaughtException] should work with the -r flag
...
## [node-tap:default] [unhandledRejection] should allow overriding 'opts.level'
...
## [node-tap:default] [unhandledRejection] should make tests fails
...
## [node-tap:default] [unhandledRejection] should work with the -r flag
...
## [node-tap:default] [warning] should allow overriding 'opts.level'
...
## [node-tap:default] [warning] should make tests fails
...
## [node-tap:default] [warning] should work with the -r flag
