...
## should work with register | uncaughtException ava
...
## should work with register | uncaughtException mocha
...
## should work with register | uncaughtException jasmine
...
## should work with register | uncaughtException tape
...
## should work with register | unhandledRejection ava
...
## should work with register | unhandledRejection mocha
...
## should work with register | unhandledRejection jasmine
...
## should work with register | unhandledRejection tape
...
## should work with register | rejectionHandled mocha
...
## should work with register | rejectionHandled jasmine
...
## should work with register | rejectionHandled tape
...
## should work with register | multipleResolves ava
...
## should work with register | multipleResolves mocha
...
## should work with register | multipleResolves jasmine
...
## should work with register | multipleResolves tape
...
## should work with register | warning ava
...
## should work with register | warning mocha
...
## should work with register | warning jasmine
...
## should work with register | warning tape
